...
const WelcomeModal: React.FC<WelcomeModalProps> = ({ isOpen, onClose }) => {
    ...
    const features = [
        ...
        "Filtre por localização e distância",
            ...
            {isOpen && (
                ...
                >
                    ...
                    >
                        ...
                        <h2 className="text-2xl font-bold text-white mb-3">Descubra Prestadores Perto de Você ✨</h2>
                        <p className="text-gray-400 mb-6">
                           Explore e encontre o serviço ideal! Aqui você pode ver todos os profissionais que atendem na sua área.
                        </p>
                        ...
                        <div className="flex items-center justify-center mt-4">
                            ...
                            />
                            <label htmlFor="dontShowAgain" className="ml-2 text-sm text-gray-400 cursor-pointer">
